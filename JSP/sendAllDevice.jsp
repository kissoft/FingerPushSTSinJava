...
<%
  ...
  * --------------------------------------------------------------------------------
  * 	2016-05-25            	PandaO_OBae				v3.0 항목 추가 함.
  */
%>    
...
<%
	...
	push.setFnm("http://www.kissoft.co.kr/images/common/img_logo_m.png");											// 이미지 파일 경로 : ex) http://도메인/이미지 파일 경로
