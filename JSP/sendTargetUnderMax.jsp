...
<%
  ...
  * file descriiption	: 타겟팅/500건 이하/동일 메시지
  *
  *
...
<%
	...
	push.setMsg("Hello World ! - under max");				// 발송할 푸시 메시지
	...
	*/
	...
	// 배열에 해당 메시지를 수신받을 식별자 셋팅 : 500건 이하 
	...
	try{
		out.println(pushDao.sendUnderMax(push, userList));		// 타겟/500건이하/동일메시지
	}catch(Exception e){
